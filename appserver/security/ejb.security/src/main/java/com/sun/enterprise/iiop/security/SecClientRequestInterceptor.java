 ...
 * and receive the service context in a service context element in the service context list in an
 * IIOP header.
 *
 * 
 */
...
public class SecClientRequestInterceptor extends org.omg.CORBA.LocalObject implements ClientRequestInterceptor {
    ...
    /**
     * prname (name + "::") is name of interceptor used for logging purposes. It is only used in the
     * call to Logger.methodentry() in this file. Its purpose is to identify the interceptor name
     */
    ...
    /**
     * Retrieves a single credential from a credset for the specified class. It also performs some
     * semantic checking and logging.
     * 
    ...
    private java.lang.Object getCred(Set credset, Class c) {
        ...
        if (credset.size() != 1) {
            if (_logger.isLoggable(Level.SEVERE))
                _logger.log(Level.SEVERE, "iiop.multiple_credset",
                        new java.lang.Object[] { Integer.valueOf(credset.size()), clsname });
            throw new SecurityException(
                    localStrings.getLocalString("secclientreqinterceptor.inv_credlist_size", "Credential list size is not 1."));
        }
    ...
    public void send_request(ClientRequestInfo ri) throws ForwardRequest {
        ...
        try {
            ...
            throw new SecurityException(localStrings.getLocalString("secclientreqinterceptor.err_cdr_encode",
    ...
    public void receive_reply(ClientRequestInfo ri) {
        ...
        try {
            ...
            throw new SecurityException(localStrings.getLocalString("secclientreqinterceptor.err_cdr_decode",
