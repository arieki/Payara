...
/**
 * <p>Java Class of list complex type.
 * 
 * 
 * 
 * <pre>
...
@XmlType(name = "list", namespace = "http://www.hazelcast.com/schema/config", propOrder = {
...
public class List {
    ...
    public static class ItemListeners {
        ...
        protected java.util.List<ItemListener> itemListener;
         ...
         * 
         */
        public java.util.List<ItemListener> getItemListener() {
